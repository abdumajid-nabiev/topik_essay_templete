...
# from handlers.common import save_essay, count_squares
# import io
# import os
# import re
# import json
# import bot_admin
# from handlers import essay
...
#     # Save user info and essay automatically
#     await bot_admin.save_user_info(update, context)

#     # Keep buffer for generating image
#     context.user_data.setdefault("essay_buffer", [])
#     context.user_data["essay_buffer"].append(update.message.text)

#     # Also save to user_essays so /done can work
#     bot_admin.user_essays.setdefault(user_id, "")
#     bot_admin.user_essays[user_id] += update.message.text
...
#     # Save essay
#     save_essay(user_id, corrected_text_normalized, score)
